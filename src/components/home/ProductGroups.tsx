...
export default function ProductGroups() {
  return (
    <section id="urun-gruplari" className="bg-background py-24 scroll-mt-20">
      <Container>
        <Reveal>
          <Eyebrow>Ürün Grupları</Eyebrow>
          <h2 className="mt-4 max-w-2xl text-3xl font-semibold text-primary sm:text-4xl">
            Sivil havacılık tedarik ihtiyaçlarınız için ürün grupları
          </h2>
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
            Sivil havacılık operasyonları, bakım süreçleri ve teknik tedarik ihtiyaçları için
            farklı ürün gruplarında talep bazlı tedarik desteği sağlıyoruz.
          </p>
        </Reveal>
