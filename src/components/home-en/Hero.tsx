      ...
      <Container className="relative py-28 sm:py-36 lg:py-44">
        ...
        <Reveal delay={0.34}>
          <dl className="mt-16 flex flex-wrap gap-3">
            {[
              { icon: Layers, value: "25,000+", label: "Product Types" },
              { icon: Plane, value: "35+", label: "Airlines Served" },
            ...
            <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 px-5 py-3.5 backdrop-blur-sm">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <dd className="text-sm font-semibold text-white">{SITE.email ?? "Coming soon"}</dd>
