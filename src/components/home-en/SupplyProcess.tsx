...
import { SUPPLY_STEPS_EN, WA_MESSAGES_EN, waLink } from "@/lib/constants";
      ...
      <Container>
        <Reveal>
          <div className="max-w-2xl">
            <Eyebrow>Supply Process</Eyebrow>
        ...
        <div className="relative mt-14">
          <div className="absolute left-6 top-2 h-[calc(100%-1rem)] w-px bg-border" aria-hidden />
          <ol className="space-y-8">
            {SUPPLY_STEPS_EN.map((step, i) => (
        ...
        <Reveal delay={0.1}>
          <div className="mt-6 flex justify-center">
            <WaButton href={waLink(WA_MESSAGES_EN.general)}>Send Request with Part Number</WaButton>
          </div>
        </Reveal>
      </Container>
    </section>
